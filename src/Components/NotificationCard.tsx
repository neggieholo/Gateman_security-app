    ...
    >
      <View className="flex-row justify-between items-center mb-2">
        <View className="flex-row items-center">
          ...
          <Text
            className={`${isDarkMode ? "text-white" : "text-gray-400"} font-bold uppercase tracking-widest text-[10px]`}
          >
            {Theme.label}
          </Text>
        </View>
      ...
      <Text
        className={`text-lg font-bold ${isDarkMode ? "text-white" : "text-gray-800"}  mb-1 leading-6`}
      >
        {item.title}
      </Text>

      <View
        className={`mt-2 p-3 rounded-xl flex-row items-start ${isDarkMode ? "bg-gm-navy border border-gm-gold" : "bg-gray-50 "}`}
      >
        <Info
          size={16}
          color={theme.accent}
        ...
        />
        <Text
          className={`${isDarkMode ? "text-white" : "text-gray-600"} text-sm flex-1 leading-5`}
        >
          {item.message}
        </Text>
      </View>
