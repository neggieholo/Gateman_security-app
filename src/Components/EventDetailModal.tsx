        ...
        >
          ...
          >
            <TouchableOpacity
              ...
              className={`flex-1 p-4 rounded-3xl border-2 flex-row items-center justify-center ${activeTab === "details" ? "bg-white" : "border-gray-300"}`}
            >
              <Text
                className={`text-center font-oswald-semibold ${activeTab === "details" ? "text-gm-navy" : isDarkMode ? "text-slate-300" : "text-slate-400"}`}
              >
                Details
              </Text>
            </TouchableOpacity>
            ...
            <TouchableOpacity
              ...
              className={`flex-1 p-4 rounded-3xl border-2 flex-row items-center justify-center ${activeTab === "guests" ? "bg-white" : "border-gray-300"}`}
            >
              <Text
                className={`text-center font-oswald-semibold ${activeTab === "guests" ? "text-gm-navy" : isDarkMode ? "text-slate-300" : "text-slate-400"}`}
              >
                Guest List
              </Text>
            </TouchableOpacity>
          ...
          {activeTab === "details" ? (
            ...
            >
              ...
              <Text
                className={`text-lg font-roboto-regular ${isDarkMode ? "text-slate-300" : "text-slate-900"} mb-6`}
              >
                {event.title}
              </Text>
              ...
              <Text
                className={`${isDarkMode ? "text-slate-300" : "text-slate-600"} text-sm font-roboto-regular uppercase mb-6`}
              >
              ...
              <Text
                className={`${isDarkMode ? "text-slate-300" : "text-slate-600"} font-roboto-regular leading-6 mb-6`}
              >
                {event.description}
              </Text>
            </ScrollView>
            ...
            <View className="flex-1 p-6">
              ...
              <View className="flex-row gap-2 mb-4">
                {["all", "inside", "out"].map((status) => {
                  ...
                  return (
                    ...
                    >
                      <Text
                        className={`text-center text-[10px]  font-oswald-semibold uppercase  ${isSelected ? (isDarkMode ? "text-gm-gold" : "text-white") : "text-gray-500"}`}
                      >
                        {status === "inside"
                          ? "Inside"
                          : status === "out"
              ...
              <TouchableOpacity
                ...
                className={`${isDarkMode ? "border-red-400 " : "bg-rose-50 border-rose-100 "} border p-3 rounded-2xl mb-4 flex-row justify-center items-center`}
              >
